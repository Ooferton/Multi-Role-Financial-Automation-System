...
class StrategyGenome:
    ...
    # --- v2 Indicator Weights ---
    histogram_weight: float = 1.0
    bb_position_weight: float = 1.0
    sma50_weight: float = 1.0
    atr_weight: float = 1.0
    obv_weight: float = 1.0
...
GENOME_BOUNDS = {
    ...
    # v2 indicator weights
    'histogram_weight':     (0.0, 3.0),
    'bb_position_weight':   (0.0, 3.0),
    'sma50_weight':         (0.0, 3.0),
    'atr_weight':           (0.0, 3.0),
    'obv_weight':           (0.0, 3.0),
}
...
class StrategyEvolver:
    ...
    def get_status(self) -> str:
        ...
        return (
            ...
            f"  v2 Weights: Histogram={g.histogram_weight:.1f} BB_Pos={g.bb_position_weight:.1f} "
            f"SMA50={g.sma50_weight:.1f} ATR={g.atr_weight:.1f} OBV={g.obv_weight:.1f}\n"
