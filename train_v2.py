...
def train_v2():
    ...
    # Higher LR for faster convergence with richer feature set
    agent = RLAgentV2(training_data=df, learning_rate=0.0005)
    ...
    logger.info(f"Starting Training for {training_duration_minutes} minutes with LR=0.0005...")
